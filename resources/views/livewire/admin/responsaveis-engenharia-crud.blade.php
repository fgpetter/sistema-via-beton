...
>
    <div class="card mt-4">
        <div class="card-header">
            <h6 class="card-title">Responsáveis Engenharia Banrisul</h6>
        ...
        <div class="flex flex-col">
                        ...
                        <table class="min-w-full divide-y divide-default-200">
                            <thead class="bg-default-150">
                                <tr class="text-sm font-normal text-default-700 whitespace-nowrap">
                                    ...
                                    <th class="px-3.5 py-3 text-start" scope="col">Situação</th>
                                    <th class="px-3.5 py-3 text-start" scope="col">Ações</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($this->responsaveisList as $item)
                                    <tr wire:key="responsavel-engenharia-{{ $item->id }}" class="text-default-800 font-normal text-sm whitespace-nowrap">
                                        <td class="px-3.5 py-3">{{ $item->nome }}</td>
            ...
            @if ($this->responsaveisList->hasPages())
                <div class="card-footer">
                    {{ $this->responsaveisList->links() }}
                </div>
            @endif
        </div>
    </div>
    ...
    <template x-teleport="body">
        <div
            ...
            role="dialog"
            tabindex="-1"
            aria-labelledby="responsavel-engenharia-modal-title"
        >
            <div
                x-show="showModal"
            ...
            <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-56px)] flex items-center relative z-10">
                ...
                >
                    <div class="flex justify-between items-center p-4 border-b border-default-200">
                        <h3 id="responsavel-engenharia-modal-title" class="font-bold text-default-800 text-base">
                            {{ $editingId ? 'Editar Responsável Engenharia Banrisul' : 'Novo Responsável Engenharia Banrisul' }}
                        </h3>
                    ...
                    <form wire:submit="save">
                        <div class="p-4 overflow-y-auto">
                            <div class="space-y-4">
                                <div>
                                    <label for="responsavel-engenharia-nome" class="block text-sm font-medium text-default-700 mb-1">Nome</label>
                                    <input
                                        wire:model.blur="nome"
                                        type="text"
                                        id="responsavel-engenharia-nome"
                                        class="form-input w-full @error('nome') border-danger @enderror"
                                        placeholder="Ex.: Dustin Hofman"
                                    >
                                    @error('nome')
    ...
    <template x-teleport="body">
        <div
            ...
            role="dialog"
            tabindex="-1"
            aria-labelledby="delete-responsavel-engenharia-modal-title"
        >
            <div
                x-show="showDeleteModal"
                x-transition:enter="ease-out duration-200"
            ...
            <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-56px)] flex items-center relative z-10">
                ...
                >
                    <div class="flex justify-between items-center p-4 border-b border-default-200">
                        <h3 id="delete-responsavel-engenharia-modal-title" class="font-bold text-default-800 text-base">
                            Inativar Responsável Engenharia Banrisul
                        </h3>
                    ...
                    <div class="p-4 overflow-y-auto">
                        <p class="text-sm text-default-500">
                            Tem certeza que deseja inativar este responsável? Ele deixará de aparecer nos formulários, mas poderá ser restaurado.
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-2 p-4 border-t border-default-200">
                        ...
                        <button
                            ...
                            wire:loading.attr="disabled"
                        >
                            <span wire:loading.remove wire:target="delete">Inativar</span>
                            <span wire:loading wire:target="delete">Inativando...</span>
                        </button>
                    </div>
                </div>
            </div>
